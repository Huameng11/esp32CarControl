...
void MyMPU6050::dataGetAndFilter() {
    ...
    gx = (g.gyro.x - MPU6050ERROR[3]) * RAD_TO_DEG*(90.0/67.0);
    gy = (g.gyro.y - MPU6050ERROR[4]) * RAD_TO_DEG*(90.0/67.0);
    gz = (g.gyro.z - MPU6050ERROR[5]) * RAD_TO_DEG*(90.0/67.0);
